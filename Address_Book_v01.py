...
conn = sqlite3.connect('c:/Users/haugl/PycharmProjects/TutorialPlayground/address_book.db')
...
def edit():
    ...
    editor.iconbitmap('c:/Users/haugl/PycharmProjects/TutorialPlayground/Images/icon.ico')

...
my_text = Text(root, width=10, height=1, font=('Helvetica', 16), selectbackground='yellow',
...
my_text = Text(root, width=70, height=4, font=('Helvetica', 16), selectbackground='yellow',
               selectforeground='black', undo=True)
...
status_bar.grid(row=6, column=2, ipady=15)
...
submit_button.grid(row=6, column=1, ipady=5)

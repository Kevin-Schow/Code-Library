...
def save_as_png():
    result = filedialog.asksaveasfilename(initialdir='c:/Users/haugl/PycharmProjects/TutorialPlayground/Images/', filetypes=(('png files', '*.png'), ('all files', '*.*')))
    ...
    # Using Image Grab Get Only the Canvas and Save It
    if result:
